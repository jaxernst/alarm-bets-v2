...
ResourceId constant _tableId = ResourceId.wrap(
  bytes32(abi.encodePacked(RESOURCE_TABLE, bytes14(""), bytes16("DailyCheckIn")))
);
ResourceId constant DailyCheckInTableId = _tableId;

FieldLayout constant _fieldLayout = FieldLayout.wrap(
  0x0004010104000000000000000000000000000000000000000000000000000000
);

struct DailyCheckInData {
  uint32 endTime;
  uint8[] alarmDays;
}

library DailyCheckIn {
  /**
   ...
   * @notice Get endTime.
   */
  function getEndTime(bytes32 key) internal view returns (uint32 endTime) {
   ...
   * @notice Get endTime.
   */
  function _getEndTime(bytes32 key) internal view returns (uint32 endTime) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
   ...
   * @notice Set endTime.
   */
  function setEndTime(bytes32 key, uint32 endTime) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
   ...
   * @notice Set endTime.
   */
  function _setEndTime(bytes32 key, uint32 endTime) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
   ...
   */
  function get(bytes32 key) internal view returns (DailyCheckInData memory _table) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
   ...
   * @notice Get the full data.
   */
  function _get(bytes32 key) internal view returns (DailyCheckInData memory _table) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
   ...
   */
  function set(bytes32 key, uint32 endTime, uint8[] memory alarmDays) internal {
    bytes memory _staticData = encodeStatic(endTime);
   ...
   * @notice Set the full data using individual values.
   */
  function _set(bytes32 key, uint32 endTime, uint8[] memory alarmDays) internal {
    bytes memory _staticData = encodeStatic(endTime);
   ...
   */
  function set(bytes32 key, DailyCheckInData memory _table) internal {
    bytes memory _staticData = encodeStatic(_table.endTime);
   ...
   * @notice Set the full data using the data struct.
   */
  function _set(bytes32 key, DailyCheckInData memory _table) internal {
    bytes memory _staticData = encodeStatic(_table.endTime);
   ...
   */
  function decodeStatic(bytes memory _blob) internal pure returns (uint32 endTime) {
    endTime = (uint32(Bytes.slice4(_blob, 0)));
  }
  ...
  ) internal pure returns (DailyCheckInData memory _table) {
    (_table.endTime) = decodeStatic(_staticData);
   ...
   */
  function encodeStatic(uint32 endTime) internal pure returns (bytes memory) {
    return abi.encodePacked(endTime);
  }
