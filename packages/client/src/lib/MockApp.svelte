...
<div class="flex justify-center">
	<div class="flex flex-col items-stretch text-zinc-700 h-screen min-w-[400px] max-w-[500px]">
			...
			<div class="w-full px-2">
				...
				{:else}
					...
					<div class="flex flex-col min-h-[100px] gap-2">
						...
						/>
						<div class="flex justify-between items-stretch" style="line-height:1em">
							<div class="px-2 pt-1 font-digital text-cyan-600 text-4xl font-bold">8:30 am</div>
							<div class="flex flex-col">
								...
								<div class="flex justify-end gap-1 items-center">
									<div class="px-2 text-xs rounded-full bg-cyan-400 text-white font-semibold">
										Lvl 5
									</div>
									<div
					...
					>
						<div class="flex justify-between">
							<div>
								...
								<div class="pt-2 text-zinc-400 pl-2 flex gap-1 items-center text-sm">
						...
						<div class="flex justify-end text-white">
							<div class="px-2 bg-cyan-400 text-white rounded-lg font-semibold">Check In</div>
						</div>
					</div>
					<div class={`flex bg-zinc-100 p-2 rounded-xl justify-between w-full text-zinc-500 px-2`}>
						<div>
		...
		<ul class="flex w-full justify-evenly py-2 bg-cyan-500 text-white font-bold rounded-t-lg">
			<li>Dashboard</li>
			<li>Challenges</li>
			<li>Friends</li>
		</ul>
