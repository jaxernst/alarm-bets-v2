...
ResourceId constant _tableId = ResourceId.wrap(
  bytes32(abi.encodePacked(RESOURCE_TABLE, bytes14(""), bytes16("Timezone")))
);
ResourceId constant TimezoneTableId = _tableId;
...
library Timezone {
   ...
   * @notice Get value.
   */
  function _get(bytes32 key) internal view returns (int8 value) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
   ...
   * @notice Set value.
   */
  function _set(bytes32 key, int8 value) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
   ...
   */
  function encodeStatic(int8 value) internal pure returns (bytes memory) {
   ...
   */
  function encode(int8 value) internal pure returns (bytes memory, PackedCounter, bytes memory) {
